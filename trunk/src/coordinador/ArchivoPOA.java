 ...
 implements coordinador.ArchivoOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("actualizarPartes", new java.lang.Integer (5));
    _methods.put ("eliminarSeed", new java.lang.Integer (6));
    _methods.put ("eliminarPeer", new java.lang.Integer (7));
    _methods.put ("getSeeds", new java.lang.Integer (8));
    _methods.put ("getPeers", new java.lang.Integer (9));
    _methods.put ("getPartes", new java.lang.Integer (10));
  }
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       {
         int id = in.read_long ();
         cliente.parteArchivo partes[] = cliente.vPartesHelper.read (in);
         this.insertarPeer (id, partes);
         out = $rh.createReply();
         break;
       }

       case 5:  // coordinador/Archivo/actualizarPartes
       {
         int id = in.read_long ();
         cliente.parteArchivo partes[] = cliente.vPartesHelper.read (in);
         this.actualizarPartes (id, partes);
         out = $rh.createReply();
         break;
       }

       case 6:  // coordinador/Archivo/eliminarSeed
       {
         int id = in.read_long ();
       ...
       case 7:  // coordinador/Archivo/eliminarPeer
       {
         int id = in.read_long ();
       ...
       case 8:  // coordinador/Archivo/getSeeds
       {
         int $result[] = null;
       ...
       case 9:  // coordinador/Archivo/getPeers
       {
         int $result[] = null;
       ...
       case 10:  // coordinador/Archivo/getPartes
       {
         int id = in.read_long ();
         cliente.parteArchivo $result[] = null;
         $result = this.getPartes (id);
         out = $rh.createReply();
         cliente.vPartesHelper.write (out, $result);
         break;
       }
