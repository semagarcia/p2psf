...
abstract public class EstrArchivoHelper
{
    ...
    if (__typeCode == null)
    {
      synchronized (org.omg.CORBA.TypeCode.class)
      {
        if (__typeCode == null)
        {
          ...
          _tcOf_members0 = org.omg.CORBA.ORB.init ().create_alias_tc (cliente.vLongHelper.id (), "vLong", _tcOf_members0);
  ...
  public static cliente.EstrArchivo read (org.omg.CORBA.portable.InputStream istream)
  {
    ...
    value.partes = cliente.vLongHelper.read (istream);
    return value;
  }
  ...
  public static void write (org.omg.CORBA.portable.OutputStream ostream, cliente.EstrArchivo value)
  {
    ...
    cliente.vLongHelper.write (ostream, value.partes);
  }
