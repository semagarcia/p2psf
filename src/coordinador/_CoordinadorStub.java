...
public class _CoordinadorStub extends org.omg.CORBA.portable.ObjectImpl implements coordinador.Coordinador
{
  ...
  public cliente.Usuario getUsuario (int id)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getUsuario", true);
                $out.write_long (id);
                $in = _invoke ($out);
                cliente.Usuario $result = cliente.UsuarioHelper.read ($in);
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
