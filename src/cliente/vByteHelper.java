...
/**
* cliente/vByteHelper.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from interface.idl
* jueves 13 de mayo de 2010 17H56' CEST
*/

abstract public class vByteHelper
{
  private static String  _id = "IDL:cliente/vByte:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (cliente.vByteHelper.id (), "vByte", __typeCode);
    }
    return __typeCode;
  }
